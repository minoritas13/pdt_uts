...
<style>
    ...
    .alert-box.success { background: var(--green-bg); color: #15803d; border: 1px solid rgba(34, 197, 94, 0.15); }
    .alert-box.error { background: var(--red-bg); color: #b91c1c; border: 1px solid rgba(239, 68, 68, 0.15); }
    ...
    <div class="form-card">
        ...
        <form action="{{ route('pusat.distribusi.kirim') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="qty" id="qty" min="1" placeholder="Masukkan jumlah eks" required>
            </div>
